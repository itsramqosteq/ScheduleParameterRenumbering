...
namespace ScheduleParameterRenumbering
{
    public partial class Utility
    {
        //Author - Common 
        // modified by darwin 
        //added round  off and contains method
        //Note : - if line parallel the return value is null
        ...
        public static XYZ GetIntersection(Element element, ConduitGrid conGrid, XYZ Point)
        {
            ...
            double multiplier = radOne + radTwo + (0.5);
        ...
        public static XYZ GetIntersectionPoint(Line conduitLine, Line supportLine)
        {
            XYZ stpt = conduitLine.GetEndPoint(0);
            XYZ edpt = conduitLine.GetEndPoint(1);
            return GetIntersection(Line.CreateBound(new XYZ(stpt.X, stpt.Y, 0), new XYZ(edpt.X, edpt.Y, 0)), supportLine);
        }
