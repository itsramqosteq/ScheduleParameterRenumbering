   ...
   public  class CustomAlert
    {
        ...
        public  async Task<MessageBoxResult> Show(CustomAlertType alertType, string content = null,string host = "ScheduleParameterRenumberingRootDialog", PackIconKind? Icon = null)
        {
