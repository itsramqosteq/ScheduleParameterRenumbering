...
namespace ScheduleParameterRenumbering
{
    ...
    {
        public static PushButton ScheduleParameterRenumberingButton { get; set; }
        ...
        {
           ScheduleParameterRenumberingButton.Enabled = true;
            return Result.Succeeded;
        }
        ...
        private void OnButtonCreate(UIControlledApplication application)
        {
            ...
            string dllLocation = Path.Combine(executableLocation, "FreshEnvironment.dll");

            // Create two push buttons

            PushButtonData buttondata = new PushButtonData("FreshEnvironmentBtn", buttonText, dllLocation, "FreshEnvironment.Command")
            {
                ToolTip = buttonTooltip
            };

            BitmapImage pb1Image = new BitmapImage(new Uri("pack://application:,,,/FreshEnvironment;component/Resources/32x32.png"));
            buttondata.LargeImage = pb1Image;

            BitmapImage pb1Image2 = new BitmapImage(new Uri("pack://application:,,,/FreshEnvironment;component/Resources/16x16.png"));
            buttondata.Image = pb1Image2;

            var ribbonPanel = RibbonPanel(application);


           ScheduleParameterRenumberingButton = ribbonPanel.AddItem(buttondata) as PushButton;
